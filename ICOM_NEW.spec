...
ICOM_DIR = "G:\\ICOM_P"
_out_file = open('%s\\build\out_modules.txt'%ICOM_DIR,'w')
_out_file_r = open('%s\\build\out_modules_r.txt'%ICOM_DIR,'w')
...
exe = EXE(pyz,
          ...
          a.zipfiles,
          a.datas,
          [('.ICOM_config.xml','%s\\.ICOM_config.xml'%ICOM_DIR,'DATA'),('license.txt','%s\\license.txt'%ICOM_DIR,'DATA')],
          [('data.bin','%s\\data.bin'%ICOM_DIR,'DATA'),('dataCommon.bin','%s\\dataCommon.bin'%ICOM_DIR,'DATA')],
          [('icon.ico','%s\\icon.ico'%ICOM_DIR, 'DATA'),('earth.ico','%s\\earth.ico'%ICOM_DIR, 'DATA')],
          name='ICOM',
          debug=False,
          strip=False,
          upx=False,
          console=False,
          icon='%s\\earth.ico'%ICOM_DIR)
...
exe_d = EXE(pyz,
          ...
          [('.ICOM_config.xml','%s\\.ICOM_config.xml'%ICOM_DIR,'DATA'),('license.txt','%s\\license.txt'%ICOM_DIR,'DATA')],
          [('data.bin','%s\\data.bin'%ICOM_DIR,'DATA'),('dataCommon.bin','%s\\dataCommon.bin'%ICOM_DIR,'DATA')],
          [('icom.bin','%s\\icom.rar'%ICOM_DIR,'DATA')],
          [('icon.ico','%s\\icon.ico'%ICOM_DIR, 'DATA'),('earth.ico','%s\\earth.ico'%ICOM_DIR, 'DATA')],
          name='ICOM_d',
          debug=True,
          strip=False,
